...
export default function EditEventPage() {
  ...
  return (
    <div className="p-4 pt-28 pb-20 text-black">
      <h1 className="text-2xl font-bold mb-4 text-white">Edit Event</h1>
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label className="block font-bold mb-2 text-white">Event Name</label>
          <input
            type="text"
            name="event_name"
        ...
        <div className="mb-4">
          <label className="block font-bold mb-2 text-white">Start Date</label>
          <input
            type="datetime-local"
            name="start_date"
        ...
        <div className="mb-4">
          <label className="block font-bold mb-2 text-white">End Date</label>
          <input
            type="datetime-local"
            name="end_date"
        ...
        <div className="mb-4">
          <label className="block font-bold mb-2 text-white">Location</label>
          <input
            type="text"
            name="location"
        ...
        <div className="mb-4">
          <label className="block font-bold mb-2 text-white">Available Slots</label>
          <input
            type="number"
            name="spot"
            value={event.spot}
        ...
        <button
          type="submit"
          className="bg-green-500 text-white hover:text-black px-4 py-2 rounded hover:bg-green-300"
        >
          Save Changes
        </button>
      </form>
