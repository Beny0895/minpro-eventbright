...
export default function FindEventPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-4 pb-32 pt-32">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {events.map((event) => (
          <div key={event.event_id} className="border p-4 rounded shadow">
            ...
            {user && event.spot > 0 && (
              <button
                className="bg-green-500 hover:bg-green-300 text-white hover:text-black font-bold py-2 px-4 rounded"
