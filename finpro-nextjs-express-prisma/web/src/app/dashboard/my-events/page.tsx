...
export default function MyEvents() {
  ...
  return (
    <div className="p-4 pt-28 pb-20">
      <h1 className="text-2xl font-bold mb-4 text-center">My Events</h1>
      {events.map((event) => (
        <div key={event.event_id} className="bg-gray-100 p-4 mb-4 rounded shadow text-black">
          ...
          <button
            className="bg-blue-500 text-white hover:text-black px-4 py-2 mt-4 rounded hover:bg-blue-300 mr-2"
          ...
          <button
            className="bg-green-500 text-white hover:text-black px-4 py-2 mt-4 rounded hover:bg-green-300"
      ...
      {isModalOpen && selectedEvent && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white text-black rounded shadow-lg p-6 w-full max-w-3xl overflow-y-auto max-h-[80vh]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {transactions[selectedEvent.event_id].map((transaction, index) => {
                  ...
                  return (
                    <div
                      key={transaction.id}
                      className="border border-gray-300 rounded p-4 shadow-sm bg-white text-black"
                    >
                      <h4 className="text-lg font-bold mb-2 text-black">Transaction #{index + 1}</h4>
                      <p>
