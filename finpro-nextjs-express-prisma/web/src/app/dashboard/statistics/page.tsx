...
export default function EventStatistics() {
  ...
  return (
    <div className="p-4 pt-28 pb-10">
      <h1 className="text-2xl font-bold mb-4 text-white">Event Statistics</h1>

      <div className="mb-4 ">
        <label className="block mb-2 font-bold text-black">Filter By:</label>
        <select
          value={filterType}
          onChange={(e) => handleFilterChange(e.target.value)}
          className="border border-white rounded p-2 text-black"
        >
