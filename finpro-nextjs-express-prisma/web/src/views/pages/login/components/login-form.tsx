  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-[50vh] bg-gray-100 ">
      <div className="bg-white shadow-lg rounded-lg p-6 w-full max-w-md border border-gray-300">
            ...
            return (
              <Form>
                <div>
                  ...
                  <input
                    className=" border border-gray-500 text-sm rounded-lg block w-full p-2.5  dark:border-gray-600 dark:placeholder-gray-400 dark:text-black"
                    type="text"
                    name="email"
                ...
                <button
                  className="mt-5 bg-blue-500 hover:bg-blue-300 text-white hover:text-black font-bold py-2 px-4 rounded w-full"
                  type="submit"
                >
                  Login
                </button>
        ...
        <button
          className="mt-3 bg-green-500 hover:bg-green-300 text-white hover:text-black font-bold py-2 px-4 rounded w-full"
